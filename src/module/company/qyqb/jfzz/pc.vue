...
<template>
    <div class="container">
        ...
        <Row class="bg">
            ...
            <Col span="6">
                    积分账户：
                    <span>{{$_message_$.credits}}</span>积分
            ...
            <Row>
                ...
                <Col span="7" class="box">
                    <div class="box1 three line35" ref="step3">
                        ...
                        <FormItem>
                            <Button type="dashed" @click="$_cancel_$">取消</Button>
                    ...
                    if (res.status === 200) {
                        if (res.data.code === 0) {
                            if (res.data.data) {
                                ...
                                this.$_data_$ = this.$_dg_$(this.$_bumen_$);
                            }
                        }
                    }
                });
                                ...
                                this.$_sendQuery_$({
                                    ...
                                    if (rsp.status === 200) {
                                        if (rsp.data.code === 0) {
                                            ...
                                            this.$root.$_Route_$("company", "qyqb", "myzh", {id: 1});
                                        } else {
