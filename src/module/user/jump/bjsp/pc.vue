        ...
        <div title="编辑商品">
            <el-form ref="addForm" :model="$_goodsData_$" :rules="addValidator" label-width="90px">
                ...
                <el-form-item label="商品详情" prop="info">
                    <!--<el-input v-model="$_goodsData_$.info"></el-input>-->

                    <quill-editor ref="myTextEditor"
                                  v-model="$_goodsData_$.info"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.$_file_$ = this.$root.inparams.file;
            for(var key in this.$_file_$){
                var temp={};
                var arr= this.$_file_$[key].split('/');
                temp.name =arr[arr.length-1];
                temp.url=this.$_file_$[key];
        ...
        methods: {
            ...
            $_addEdit_$() {
                ...
                this.$_goodsData_$.image = this.$_file_$.join(';')
...
// 移除
            ...
            beforeuploadEdit(file) {
                this.$set(this.$_goodsData_$, 'images', this.$_file_$)
            },
            // 移除
            ...
            uploadSuccessEdit(res, file, fileList) {
                this.$_goodsData_$.file = res.data;
