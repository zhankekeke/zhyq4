    ...
    export default {
        ...
        data() {
             const validateaddr = (rule, value, callback) => {
                if (this.$_addAssembForm_$.buildingId != "" && this.$_addAssembForm_$.floorId != "" && this.$_addAssembForm_$.roomIds != "") {
                    callback();
                } else {
                    callback('请选择地址');
                }
            ...
            return{
                ...
                addAssembFormValidate: {
                   ...
                   //add: [{required: true, message:'请选择地址', trigger: 'change'}],
                  address: [
                ...
                peopleNumber:[
                    ...
                    // area:[
                    //     {max:10, message: '面积不能超过10位数', trigger: 'change'},
                    //     {validator:number,trigger:'change'},
                    //     {validator:this.$_validatestr_$,trigger:'change'}
                    // ],
                },
            ...
            $_edit_$() {
                ...
                if (this.row.images.length > 0) {
                    for (let i = 0; i < this.row.images.length; i++) {
                        ...
                        this.$_file_$.push({imgageUrl:this.row.images[i].imageUrl})
                    }
