...
<div class="zdtb">
    <!-- 服务编辑 -->
            <el-form ref="editForm" :model="$_editForm_$" :rules="$_addRuleValidate_$" label-width="90px">
                ...
                <el-form-item label="服务介绍" prop='description'>
                    <quill-editor ref="myTextEditor"
                                  v-model="$_editForm_$.description"
            ...
            <div slot="footer" class="dialog-footer">
                <el-button @click="$_editmodal_$()">取 消</el-button>
...
export default {
    ...
    data(){
     ...
     created(){
         ...
         this.$_file_$.push(this.$_editForm_$.imageUrl);
          this.$_list_$();      
         this.$_xqlist_$();
                ...
                this.$_sendQuery_$({
                    ...
                    if(rsp.status === 200){
                        if(rsp.data.code === 0){
                            ...
                            this.$_sendQuery_$({
                                method: "POST",
                                url:`${this.$_global_$.serverPath}/zone/zone/${this.zoneId}/service/category/${this.parentId}/pageList`,
                                data:{},
                                headers:{"Content-type":"application/json"}
                            }).then((rsp)=>{
                                if(rsp.status === 200){
